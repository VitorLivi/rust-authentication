use super::user_model::GroupModel;
use crate::core::domain::entities::user::Group;
use std::time::SystemTime;

pub struct GroupMapper {}

impl GroupMapper {
    pub fn to_entity(user_model: &GroupModel) -> Group {
        Group::new(
            Some(user_model.id),
    ...
    pub fn to_model(user: &Group) -> GroupModel {
